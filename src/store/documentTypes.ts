...
// Upd: Если мы редактируем типы документов по компаниям, то, вероятно, нужен отдельный стор для каждой компании: так же, как сделано сейчас с администрированием юзеров по компаниям
