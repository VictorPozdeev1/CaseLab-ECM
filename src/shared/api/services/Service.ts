...
name: string,
     ...
     * @throws ApiError
     */
    public static getUsersMyOrganization(): CancelablePromise<Array<UserReplyDto>> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/v2/org/my/users',
        });
     ...
     * @throws ApiError
     */
    public static getDocTypesMyOrganization(): CancelablePromise<Array<DocTypeDto>> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static getAttributesMyOrganization(): CancelablePromise<Array<DocAttributeDto>> {
        return __request(OpenAPI, {
            method: 'GET',
...
processId: number,
     ...
     * @throws ApiError
     */
    public static findOutgoingProcesses(): CancelablePromise<Array<DocProcessDto>> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static findIncomingProcesses(): CancelablePromise<Array<DocProcessDto>> {
        return __request(OpenAPI, {
            method: 'GET',
